...
const Success = ({ products }: Props) => {
  ...
  return (
    <div>
      {' '}
      <Head>
        <title>NextJs-App - Thank You!</title>{' '}
        <link
      ...
      <main className='grid grid-cols-1 lg:grid-cols-9'>
        ...
        lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44'
        >
          <Link href='/'>
            <div
              className='relative ml-14 hidden h-24 w-12
              cursor-pointer transition lg:inline-flex'
            >
              <Image
                src='https://cdn-icons-png.flaticon.com/512/4815/4815708.png'
                fill
          ...
          <div className='my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0'>
            ...
            justify-center rounded-full border-2 border-black'
            >
          ...
          <div
            className='mx-4 divide-y divide-gray-300 
          rounded-md border border-gray-300 p-4 lg:ml-14'
          >
          ...
          <div
            ...
            justify-between text-sm lg:ml-14 lg:flex-row'
          >
        ...
        {mounted && (
          ...
          border-gray-300 bg-[#FAFAFA] lg:order-2 lg:col-span-4
          ...
          >
            ...
            {showOrderSummaryCondition && (
              <div
                className='mx-auto max-w-xl divide-y border-gray-300
              px-4 py-4 lg:mx-0 lg:max-w-lg lg:px-10 lg:py-16'
              >
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <div
                        ...
                        justify-center border border-gray-300 bg-[#F1F1F1]
                       text-xs text-white'
                      >
                        <div
                          className='relative h-7 w-7 animate-bounce
                        rounded-md'
                        >
                          <Image
                            src='https://cdn-icons-png.flaticon.com/512/4815/4815708.png'
                        ...
                        <div
                          ...
                          w-5 items-center justify-center rounded-full bg-[gray]
                          text-xs'
                        >
                          {product.quantity}
                        </div>
                      ...
                      <p>{product.price.unit_amount / 100} USD</p>
                    </div>
                  ))}
                </div>
                <div className='space-y-1 py-4'>
                  ...
                  <div className='flex justify-between text-sm'>
                    ...
                    <p className='font-medium'>{20} USD</p>
                  </div>
                </div>
